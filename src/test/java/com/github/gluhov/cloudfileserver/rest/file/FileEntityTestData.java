...
public class FileEntityTestData {
    ...
    public static final FileEntity fileUser2 = new FileEntity(FILE_ID+1, Status.ACTIVE, LocalDateTime.now(), LocalDateTime.now(),  "2", "2", "https://gluhov-file-storage.s3.amazonaws.com/2023-11-03%2010.52.36.jpg", "2023-11-03 10.52.36.jpg", 2L);
    ...
    public static final List<FileEntity> userFiles = Arrays.asList(fileUser2, fileUser);
